                    ...
                    <div className="flex gap-4">
                        <div className="mb-4 flex flex-col items-start ">
                            ...
                            <input
                                ...
                                className='w-full p-1 border bg-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500'
                            />
                        </div>
                        <div className="mb-4 flex flex-col items-start ">
                    ...
                    <table className='min-w-full bg-white border border-gray-200 rounded-lg shadow-lg'>
                        <thead className='bg-blue-400 text-gray-900 rounded'>
                            <tr>
                                ...
                                <th className='py-2 px-6 text-left'>Keperluan</th>
                                <th className='py-2 px-6 text-left'>Tanggal</th>
                                <th className='py-2 px-6 text-left'>Nominal</th>
                        ...
                        <tbody className='text-gray-700 text-xs'>
                            <tr className='border-b'>
                                ...
                                <td className='py-2 px-6'>Beli Lap</td>
                                <td className='py-2 px-6'>12 Nov 2024</td>
                                <td className='py-2 px-6'>5000</td>
